...
func init() {
	// defaults
	Config.WebHost = os.Getenv("HOST")
	port, _ := strconv.Atoi(os.Getenv("PORT"))
	Config.WebPort = port
	Config.DbHost = os.Getenv("OPENSHIFT_MONGODB_DB_HOST")
	mdbport, _ := strconv.Atoi(os.Getenv("OPENSHIFT_MONGODB_DB_PORT"))
	Config.DbPort = mdbport
	Config.DbName = "web"
	...
	if ecp := os.Getenv("WEB_CONFIG_PATH"); ecp != "" {
		Path = ecp
	}
